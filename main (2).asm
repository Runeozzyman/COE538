;********************************************************************************************
;* Final Project: Robot Guidance Program                                   		 *
;********************************************************************************************
...
;Guidance Variables
;--------------------------------------------------------------------------------------------
PTH_A_INT  	 EQU   $74              		 ; Path detection threshold
PTH_B_INT  	 EQU   $FF               		 ; "" 94
PTH_C_INT  	 EQU   $93              		 ; ""
PTH_D_INT  	 EQU   $6B              		 ; "" 80

PTH_E_INT  	 EQU   $75              		 ; If SENSOR_LINE < PTH_E_INT robot must shift right    65
PTH_F_INT  	 EQU   $95              		 ; If SENSOR_LINE > PTH_F_INT robot must shift left  WAS A2 PREVIOUSLY

INC_DIS		 EQU   10               		 ; INCREMENT distance
FWD_DIS		 EQU   500              		 ; FORWARD distance
REV_DIS		 EQU   1000             		 ; REVERSE distance
STR_DIS		 EQU   500              		 ; STRAIGHT distance
TRN_DIS		 EQU   14600            		 ; TURN distance
UTRN_DIS   	             EQU   13250            		 ; U-TURN distance
;--------------------------------------------------------------------------------------------
